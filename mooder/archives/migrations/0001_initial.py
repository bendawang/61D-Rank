    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('visible', models.CharField(choices=[('private', '私密的'), ('sell', '有偿的'), ('public', '公开的')], default='private', max_length=8, verbose_name='公开度')),
                ...
                ('level', models.CharField(choices=[('low', 'C级贡献'), ('medium', 'B级贡献'), ('high', 'A级贡献'), ('grave', 'S级贡献')], default='low', max_length=8, verbose_name='等级')),
                ('created_time', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('last_modify_time', models.DateTimeField(auto_now=True, verbose_name='修改时间')),
