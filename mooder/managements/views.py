...
from oauth_client.models import Invitecode
from datetime import timedelta
from . import models
from django.contrib.sessions.models import Session
from oauth_client.models import USER_LEVEL
...
class UserView(AdminPermissionMixin, PaginationMixin, ListView):
    ...
    paginate_by = 15
    permission_required = 'oauth_client.change_member'
...
class InviteCodeListView(AdminPermissionMixin, PaginationMixin, ListView):
    ...
    paginate_by = 10
    model = Invitecode
    permission_required = 'oauth_client.change_invitecode'
...
class GenerateInvitecodeView(AdminPermissionMixin, View):
    ...
    paginate_by = 10
    model = Invitecode
    permission_required = 'oauth_client.add_invitecode'
...
class DeleteInviteCodeView(AdminPermissionMixin, DeleteView):
    ...
    permission_required = 'oauth_client.delete_invitecode'
